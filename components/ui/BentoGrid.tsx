...
export const BentoGridItem = ({
  ...
  return (
    <div
      ...
      style={{
        background: 'rgb(37,51,85)',
        backgroundColor: "linear-gradient(90deg, rgba(37,51,85,0.6025641025641026) 18%, rgba(30,35,59,1) 98%)",
      }}
    >
      <div className={`${id === 6} && 'flex justify-center h-full`}>
        ...
        {id === 3 && (
          <div className="flex gap-5 lg:gap-5 w-fit absolute right-1 lg:right-1">
            <div className="flex flex-col gap-3 lg:gap-2">
              {['AR Unity','VR Unity', 'Javascript','React.js','Typescript', 'CSS','CSS'].map((item) => (
